                  ...
                  >
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">
                          Connie Lin (Design Lead), Angela Wu, Angola Babola,
                          Rachel Ma
                        </p>
                      </div>
                      <div>
                  ...
                  >
                    ...
                    <div className="space-y-4 text-gray-700 leading-relaxed">
                      <p>
                        ...
                        reporting and fish identification through a mobile app.
                        It is designed to be social, so you can see what your
                        friends and people in the area are seeing.
                      </p>
                    </div>
                  </motion.div>
                </motion.div>
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      there's high demand for a centralized platform to share
                      diving photos, ocean experiences, and marine life
                  ...
                  >
                    ...
                    <p>
                      <li className="m-3">
                        A mobile app that allows scuba divers to identify, tag,
                        and post fish that they have seen on a dive.
                      </li>
                      <li className="m-3">
                        A clean, beautiful, and usable design that entices
                        usesrs to stay and participate in posting.
                      </li>
                      <li className="m-3">
                        A gamified interface to encourage users to track their
                        dives{" "}
                      </li>
                    </p>
                  </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                  ...
                  >
                    ...
                    <p className="text-gray-700">
                      When users first open the app, they see a post feed from
                      scuba dives near them. They're able to quickly filter by
                      tags, and can navigate between seeing feeds of those they
                      are following and those who are nearby.
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-gray-700">
                      Users are able to search for locations - allowing them to
                      see posts and fish from the location of their choice. Not
                      only that, they are able to search by users, fish, and
                      posts.
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-gray-700">
                      After a dive, scuba divers can post images of fish finds
                      from their dives, tagging relevant species. They can add
                  ...
                  >
                    ...
                    <p className="text-gray-700">
                      A scuba diver's profile will show information on their
                      recent posts, as well as species that they have tagged.
                      The gamified nature of the app will allow users to earn
                      badges as they accomplish new highs in their dives.
                    </p>
                  </motion.div>
                </div>
              </section>
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-gray-700 max-w-2xl mx-auto">
                      ...
                      educational, clean, and a beautiful components and
                      branding. It consists of an ocean themed color palette
                      with strategic red snapper colored accents.
                    </p>
                  </div>
                  ...
                  <p className="text-gray-700 mb-12 mt-4 mx-auto text-left">
                    The process of designing the Snapper logo required
                    significant iteration and multiple feedback sessions. The
                    first iterations were created before the colors of the app
                    were decided, so I decided on lighter blues. Initially, I
                    also tried to create more elegant looking logos - until I
                    realized the app had a fun, youthful vibe to it. Then, I
                    embraced rounded shapes and whimsical design. After
                    establishing colors and getting feedback on the designs, I
                    was able to focus in on the design of two fish forming the
                    negative space of an S. For the wordmark, I also emphasized
                    the contrast between the Snapper red and the primary blue,
                    to highlight the scuba mask within the wordmark.
                  </p>
                  <section className="mb-8">
                  ...
                  <p className="text-gray-700 mb-8 mx-auto text-left">
                    I designed these badges to add to the gamification aspect of
                    the app. These badges were achieved in circumstances such as
                    100 dives logged, or posting for the first time.
                  </p>
