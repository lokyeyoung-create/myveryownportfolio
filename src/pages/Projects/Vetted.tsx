        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 py-16">
            ...
            >
              ...
              >
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Vetted connects pet owners with certified veterinarians for
                    trusted, specialized care through a seamless and secure
                    platform, enhancing post-medical support and general
            ...
            >
              <motion.div custom={0} variants={fadeIn} className="space-y-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  communication between pet owners seeking specialized care and
                  credentialed veterinary professionals who can provide tailored
                  support. By offering a centralized hub for communication and
                  consultation, Vetted aims to improve the quality of
                  post-medical care and general veterinary support for pets. The
                  platform combines a warm user-friendly interface with
                  authentication features, ensuring pet owners receive trusted
                  and reliable care for their beloved companions.
                </p>
              </motion.div>
              ...
              <motion.div custom={1} variants={fadeIn} className="space-y-4">
                ...
                <p>
                  <li className="m-3">
                    Ensuring the highest standards of data privacy and security
                    so pet owners and veterinary professionals feel confident
                    sharing sensitive information.
                  </li>
                  <li className="m-3">
                    Empowering pet owners with practical guidance and access to
                    the right expertise at the right time.
                  </li>
                  <li className="m-3">
                    Providing pet owners with peace of mind by connecting them
                    only with certified veterinary professionals.
                  </li>
                </p>
              </motion.div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-16">
              ...
              >
                ...
                <p className="text-gray-700">
                  ...
                  interactive map allows users to click into the profiles of pet
                  providers near them and see results in both a map and list
                  view.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700">
                  Pet parents can add one, two, three, or more pets, depending
                  on how much of a pet lover they are! Each pet has a profile of
                  their own, with information such as age, sex, medications, and
                  more.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700">
                  The careboard is a place for pet parents and pet providers to
                  connect directly. Through messages, confirmations, and a
                  rating system, pet parents can determine whether or not a pet
                  provider is the right fit for them.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700">
                  Logging in to Vetted is easy - through email, microsoft, or
                  google - pet parents can get started in just a couple of
                  minutes.
                </p>
              </motion.div>
            </div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-700 max-w-2xl mx-auto">
                  The design system brings together warmth and trust through a
                  thoughtful color palette of brick red and soft periwinkle
                  blue. The brick tones create a sense of reliability while the
                  periwinkle adds a calming touch. Clean typography and
                  organized layouts keep things professional without feeling
              ...
              <p className="text-gray-700 mb-12 mt-4 mx-auto text-left">
                Creating the branding for Vetted was a long and winding process,
                where I attempted to tie in the client's brand preferences with
                my creative vision. At first, I envisioned the logo to be fun
                and friendly. However, with the Header Type being a Serif font
                and the client preferences being more elegant, I attempted to
                create a logo that combined a more sophisticated brand with a
          ...
          <section className="mb-24">
            ...
            >
              ...
              <p className="text-gray-700 mx-auto">Landing Page Wireframes</p>
